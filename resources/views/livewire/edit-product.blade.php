<form class="md:w-1/2" wire:submit.prevent="editProduct" novalidate>
    ...
    <!-- Imagen producto -->
    <div class="mt-4">
        <x-input-label for="n_imagen" :value="__('Imagen')" />
        <x-text-input
            id="n_imagen"
            ...
            required
        />
        <x-input-error :messages="$errors->get('n_imagen')" class="mt-2" />
    </div>
    ...
    <div class="my-5 flex justify-around bg-gray-900 rounded-lg p-5 border border-gray-700">
        ...
        <img src="{{asset('storage/products/'.$imagen)}}" class="mt-2 rounded-lg border-gray-700" alt="Imagen" width="200" height="200" />
    </div>
    ...
    <div class="my-5 flex justify-around bg-gray-900 rounded-lg p-5 border border-gray-700">
        ...
        <img src="{{ $n_imagen->temporaryUrl() }}" class="mt-2 rounded-lg border-gray-700" alt="Imagen" width="200" height="200" />
    </div>
    @endif
